...
<option value="delete_and_notify" <?= selected($deleteAction, 'delete_and_notify'); ?>
    ...
    <?= _x('Automatically delete data and notify me via email', '(Admin)', 'gdpr') ?>
</option>
